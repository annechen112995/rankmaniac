...
# Input:
# Each input line is formatted as NodeId: n_id\tc_rank, p_rank, adj_list
# Where:
#           n_id is the Node id
#           \t is a tab character
...
#    
# Output:
# Each output line is formatted as 1\tconverged, NodeId: n_id\tc_rank, p_rank, adj_list
# Where:
#			\t is a tab character
...
for line in sys.stdin:
    ...
    # larger than t
    if (math.abs(c_pageRank-p_pageRank) > t):
    	converged = 0

    sys.stdout.write('1\t%s,%s\n' % (tab[0], converges, prevContent))
